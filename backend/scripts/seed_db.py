...
def seed_analytics(
    ...
    add_views(
        ...
        every_minutes=43,
        path=(
            f"/spaces/{refs['spaces']['platform-ops'].id}?docSlug=api-release-checklist"
        ),
        surface="kb",
    )
    add_views(
    ...
    add_views(
        ...
        every_minutes=120,
        path=(
            f"/spaces/{refs['spaces']['store-ops'].id}?docSlug=store-opening-checklist"
        ),
        surface="kb",
    )
    add_views(
...
def seed_presentation_users(db: Session) -> dict[str, User]:
    user_specs = {
        "executive_director": {
            "email": "avery.stone@testcompany.com",
            "name": "Avery Stone",
            "global_role": "member",
            "title": "Executive Director",
            "department_slug": "north-america-retail-operations",
        },
        "admin": {
        ...
        "moderator": {
            ...
            "title": "Europe Operations Lead",
            "department_slug": "europe-retail-operations",
        },
        "member": {
            "email": "member@member.com",
            "name": "Member",
            "global_role": "member",
            "title": "North America Support Specialist",
            "department_slug": "north-america-customer-support",
        },
        "viewer": {
            "email": "viewer@viewer.com",
            "name": "Viewer",
            "global_role": "viewer",
            "title": "Europe Support Analyst",
            "department_slug": "europe-customer-support",
        },
        "na_support_manager": {
            "email": "nora.patel@testcompany.com",
            "name": "Nora Patel",
            "global_role": "member",
            "title": "North America Support Manager",
            "department_slug": "north-america-customer-support",
        },
        "na_ops_manager": {
            "email": "liam.brooks@testcompany.com",
            "name": "Liam Brooks",
            "global_role": "member",
        ...
        "eu_support_manager": {
            "email": "eva.schneider@testcompany.com",
            "name": "Eva Schneider",
            "global_role": "member",
            "title": "Europe Support Manager",
            "department_slug": "europe-customer-support",
        },
        "eu_ops_manager": {
            "email": "max.weber@testcompany.com",
            "name": "Max Weber",
            "global_role": "member",
            "title": "Europe Operations Manager",
            "department_slug": "europe-retail-operations",
        },
        "na_support_specialist": {
            "email": "maya.bennett@testcompany.com",
            "name": "Maya Bennett",
            "global_role": "member",
            "title": "North America Escalation Specialist",
            "department_slug": "north-america-customer-support",
        },
        "na_ops_coordinator": {
            "email": "owen.carter@testcompany.com",
            "name": "Owen Carter",
            "global_role": "member",
            "title": "North America Operations Coordinator",
            "department_slug": "north-america-retail-operations",
        },
        "eu_support_specialist": {
            "email": "leon.bauer@testcompany.com",
            "name": "Leon Bauer",
            "global_role": "member",
            "title": "Europe Billing Specialist",
            "department_slug": "europe-customer-support",
        },
        "eu_ops_coordinator": {
            "email": "clara.fischer@testcompany.com",
            "name": "Clara Fischer",
            "global_role": "member",
            "title": "Europe Operations Coordinator",
            "department_slug": "europe-retail-operations",
        },
    }

    users: dict[str, User] = {}
    for index, (user_key, spec) in enumerate(user_specs.items(), start=1):
        employee_code = f"TC-{index:03d}"
        users[user_key] = get_or_create_user(
            db,
            email=spec["email"],
            name=spec["name"],
            ...
            meta={
                "employee_code": employee_code,
                "title": spec["title"],
                "department_slug": spec["department_slug"],
                "directory_source": "presentation-seed",
                "directory_tenant": "test-company",
...
def seed_presentation_organization(
    db: Session,
    users: dict[str, User],
    refs: dict[str, dict[str, Any]],
) -> None:
    north_america = get_or_create_org_unit(
        db,
        slug="north-america-region",
        ...
        meta={
            ...
            "scope": "region",
            "country_code": "US",
            "seed_cluster": "test-company",
        },
    )
    europe = get_or_create_org_unit(
        db,
        slug="europe-region",
        name="Europe Region",
        unit_type="region",
    ...
    na_support = get_or_create_org_unit(
        db,
        slug="north-america-customer-support",
        name="North America Customer Support",
        unit_type="department",
        ...
        updated_at=ts(days_ago=1),
        meta={
            "department_code": "NA-CS",
            "scope": "department",
            "seed_cluster": "test-company",
        },
    )
    na_ops = get_or_create_org_unit(
        db,
        slug="north-america-retail-operations",
        name="North America Retail Operations",
        unit_type="department",
        parent=north_america,
        active=True,
        created_at=ts(days_ago=117),
        updated_at=ts(days_ago=1),
        meta={
            "department_code": "NA-RO",
            "scope": "department",
            "seed_cluster": "test-company",
        },
    )
    eu_support = get_or_create_org_unit(
        db,
        slug="europe-customer-support",
        name="Europe Customer Support",
        unit_type="department",
        parent=europe,
        active=True,
        created_at=ts(days_ago=116),
        updated_at=ts(days_ago=1),
        meta={
            "department_code": "EU-CS",
            "scope": "department",
            "seed_cluster": "test-company",
        },
    )
    eu_ops = get_or_create_org_unit(
        db,
        slug="europe-retail-operations",
        name="Europe Retail Operations",
        unit_type="department",
        parent=europe,
        active=True,
        created_at=ts(days_ago=115),
        updated_at=ts(days_ago=1),
        meta={
            "department_code": "EU-RO",
            "scope": "department",
            "seed_cluster": "test-company",
        },
    )
    ...
    refs["departments"] = {
        ...
        "north-america-customer-support": na_support,
        "north-america-retail-operations": na_ops,
        "europe-customer-support": eu_support,
        "europe-retail-operations": eu_ops,
    }
    ...
    get_or_create_custom_role(
        ...
        description="Owns the presentation company leadership layer and department coordination.",
        effective_level="admin",
        active=True,
    )
    get_or_create_custom_role(
        ...
        description="Leads a department, assigns follow-up work, and approves operational updates.",
        effective_level="moderator",
        active=True,
    )
    get_or_create_custom_role(
        db,
        role_key="support_specialist",
        name="Support Specialist",
        description="Handles documentation quality, escalations, and customer-facing response updates.",
        effective_level="member",
        active=True,
    )
    get_or_create_custom_role(
        ...
        description="Coordinates recurring operational routines and incident follow-up tasks.",
        effective_level="member",
        active=True,
    )
    ...
    def attach_user(
        ...
        *,
        ...
        user = users[user_key]
        department = refs["departments"][department_key]
        meta = _decode_json_map(
            user.meta_json if isinstance(user.meta_json, str) else None
        )
        meta["employment_document_url"] = f"/media/dummy/employment/{user_key}.pdf"
        meta["department_count"] = 1
        meta["org_primary_unit_slug"] = department.slug
        meta["seed_profile_version"] = "presentation-v1"
        user.meta_json = json.dumps(meta, ensure_ascii=False, separators=(",", ":"))
        upsert_org_item_link(
            db,
            parent_kind="department",
    ...
    attach_user(
        "admin", "north-america-retail-operations", role_key="operations_coordinator"
    )
    attach_user(
        "moderator", "europe-retail-operations", role_key="operations_coordinator"
    )
    attach_user(
        "member", "north-america-customer-support", role_key="support_specialist"
    )
    attach_user("viewer", "europe-customer-support")
    attach_user(
        "na_support_manager",
    ...
    attach_user(
        "eu_support_manager", "europe-customer-support", role_key="department_manager"
    )
    attach_user(
        "eu_ops_manager", "europe-retail-operations", role_key="department_manager"
    )
    attach_user(
        "na_support_specialist",
        "north-america-customer-support",
    ...
    manager_pairs = [
        ("admin", "na_ops_manager"),
        ("moderator", "eu_ops_manager"),
        ("member", "na_support_manager"),
        ("viewer", "eu_support_manager"),
        ("na_support_manager", "executive_director"),
        ("na_ops_manager", "executive_director"),
        ("eu_support_manager", "executive_director"),
        ("eu_ops_manager", "executive_director"),
        ("na_support_specialist", "na_support_manager"),
        ("na_ops_coordinator", "na_ops_manager"),
        ("eu_support_specialist", "eu_support_manager"),
        ("eu_ops_coordinator", "eu_ops_manager"),
    ]
    for report_key, manager_key in manager_pairs:
        upsert_org_item_link(
            db,
            parent_kind="user",
            parent_id=users[manager_key].id,
...
def seed_presentation_spaces(
    db: Session,
    users: dict[str, User],
    refs: dict[str, dict[str, Any]],
) -> None:
    def ensure_folder_path(space: Space, path: str) -> Folder:
        current_parent: Folder | None = None
        current_path = []
        for segment in [part.strip() for part in path.split("/") if part.strip()]:
            current_path.append(segment)
            folder_key = f"{space.slug}:{'/'.join(current_path)}"
            folder = refs["folders"].get(folder_key)
            if folder is None:
                ...
                refs["folders"][folder_key] = folder
            current_parent = folder
        if current_parent is None:
            raise RuntimeError(f"Folder path cannot be empty for {space.slug}")
    ...
    def create_doc(
        *,
        ...
        folder = ensure_folder_path(space, folder_path)
        doc = get_or_create_doc(
            ...
            status="published",
            created_at=ts(days_ago=42),
            updated_at=ts(days_ago=2),
            published_at=ts(days_ago=41),
            content_md=md(content_lines),
            versions=[
                {
                    "title": title,
                    "content_md": md(content_lines),
                    "created_by": users[created_by],
                    "created_at": ts(days_ago=41),
                }
            ],
        )
        refs["docs"][key] = doc
        upsert_row(
            ...
            deleted_by=None,
            review_due_at=review_due_at,
            last_reviewed_at=ts(days_ago=5),
            last_reviewed_by=users[reviewer_key].id if reviewer_key else None,
        )
        if reviewer_key:
            upsert_row(
                db,
        ...
        upsert_translation_variants_for_fields(
            ...
            content_kind="doc",
            content_id=doc.id,
            fields={"title": doc.title, "content_md": doc.content_md},
            actor_user_id=users[updated_by].id,
        )
        return doc
    ...
    def create_sop(
        *,
        ...
        folder = ensure_folder_path(space, folder_path)
        sop = get_or_create_sop(
            db,
            space=space,
            folder=folder,
            slug=slug,
            title=title,
            overview_md=md(overview_lines),
            status="published",
            created_by=users[owner_key],
            updated_by=users[reviewer_key],
            created_at=ts(days_ago=38),
            updated_at=ts(days_ago=3),
            steps=[
                {
                    "step_order": int(step["step_order"]),
                    "title": str(step["title"]),
                    "body_md": str(step["body_md"]),
                }
                for step in steps
            ],
        )
        ...
        upsert_row(
            ...
            pk_field="sop_id",
            pk_value=sop.id,
            review_due_at=ts(days_ago=-10),
            last_reviewed_at=ts(days_ago=6),
            reviewer_user_id=users[reviewer_key].id,
            requires_approval=True,
            approved_at=ts(days_ago=6),
            approved_by=users[reviewer_key].id,
            archived_at=None,
            archived_by=None,
        )
        for order, step in sop_steps_by_order(db, sop).items():
            requires_evidence = order == len(steps)
            upsert_row(
                db,
                SopStepMeta,
                pk_field="step_id",
            ...
            if requires_evidence:
                upsert_row(
                    ...
                    follow_up_owner_user_id=users[owner_key].id,
                    follow_up_title_template=f"{title} follow-up",
                )
        schedule_id = seed_uuid("sop-run-schedule", key)
        upsert_row(
            db,
            SopRunSchedule,
            pk_field="id",
            pk_value=schedule_id,
            sop_id=sop.id,
            cadence_days=cadence_days,
            next_due_at=next_due_at,
            operator_user_id=users[owner_key].id,
            enabled=True,
            last_started_at=ts(days_ago=7),
            reminder_channels_csv="in_app,email",
            last_reminder_sent_at=ts(days_ago=1),
        )
        upsert_row(
            db,
            TaskExecutionProfile,
            pk_field="id",
            pk_value=seed_uuid("task-execution-profile", key),
            space_id=space.id,
            source_kind="sop",
            source_id=sop.id,
            source_step_id=None,
            ...
            reminder_channels_csv="in_app,email",
            last_reminder_sent_at=ts(days_ago=1),
            created_by=users[reviewer_key].id,
            created_at=ts(days_ago=21),
            updated_at=ts(days_ago=1),
        )
        upsert_translation_variants_for_fields(
            ...
            content_kind="sop",
            content_id=sop.id,
            fields={"title": sop.title, "overview_md": sop.overview_md},
            actor_user_id=users[reviewer_key].id,
        )
        return sop
    ...
    def create_incident(
        *,
        ...
        postmortem_lines: list[str] | None,
        related_doc: Doc | None = None,
        related_sop: Sop | None = None,
    ) -> Incident:
        folder = ensure_folder_path(space, folder_path)
        template = upsert_row(
            db,
            IncidentTemplate,
            pk_field="id",
            pk_value=seed_uuid("incident-template", key),
            space_id=space.id,
            name=template_name,
            incident_type="service",
            severity=severity,
            title_template=title,
            summary_template_md=md(summary_lines),
            postmortem_template_md=md(
                postmortem_lines or ["# Postmortem", "", "- Pending closure review."]
            ),
            default_impacts_json=json.dumps(impacts, ensure_ascii=False),
            active=True,
            created_by=users[created_by].id,
            created_at=ts(days_ago=30),
            updated_at=ts(days_ago=3),
        )
        refs["incident_templates"][key] = template
        incident = get_or_create_incident(
            ...
            status=status,
            severity=severity,
            summary_md=md(summary_lines),
            created_by=users[created_by],
            created_at=ts(days_ago=6),
            timeline=[
                {
                    "ts": ts(days_ago=6),
                    "entry_md": "Incident opened after the first customer or store report.",
                    "created_by": users[created_by],
                },
                {
                    "ts": ts(days_ago=5, hours=18),
                    "entry_md": "Owner confirmed scope and recorded immediate mitigation work.",
                    "created_by": users[on_call_key],
                },
                {
                    "ts": ts(days_ago=5, hours=8),
                    "entry_md": "Status update drafted for the affected stakeholders and working teams.",
                    "created_by": users[on_call_key],
                },
            ],
        )
        refs["incidents"][key] = incident
        upsert_row(
            db,
            IncidentMeta,
            pk_field="incident_id",
            pk_value=incident.id,
            postmortem_md=md(postmortem_lines or []),
        )
        upsert_row(
            db,
            IncidentProfile,
            ...
            escalation_status="normal" if status != "open" else "bridge_open",
            escalation_notes="Seeded for presentation demo.",
            blast_radius_summary="Impacted one department space with clear owner handoff.",
        ...
        for idx, impact in enumerate(impacts, start=1):
            upsert_row(
                ...
                IncidentImpactService,
                pk_field="id",
                pk_value=seed_uuid("incident-impact", key, str(idx)),
                incident_id=incident.id,
        ...
        for idx, update in enumerate(status_updates, start=1):
            status_row = upsert_row(
                db,
                IncidentStatusUpdate,
                pk_field="id",
                pk_value=seed_uuid("incident-status-update", key, str(idx)),
                incident_id=incident.id,
                stream_type=str(update.get("stream_type", "private")),
                status=str(update.get("status", "update")),
                message_md=str(update["message_md"]),
                created_by=users[str(update["created_by"])].id,
                created_at=update.get("created_at") or ts(days_ago=5),
            )
            refs["incident_status_updates"] = refs.get("incident_status_updates", {})
            refs["incident_status_updates"][f"{key}:{idx}"] = status_row
        previous_status: str | None = None
        for idx, target_status in enumerate(["open", status], start=1):
            if idx == 1 and status == "open":
                continue
            ...
            upsert_row(
                ...
                IncidentStatusTransition,
                pk_field="id",
                pk_value=seed_uuid("incident-transition", key, str(idx)),
                incident_id=incident.id,
                from_status=previous_status,
                to_status=target_status,
                note_md="Seeded transition",
                changed_by=users[on_call_key].id,
                changed_at=ts(days_ago=5, hours=12 - idx),
            )
        ...
        for idx, item in enumerate(action_items, start=1):
            action = upsert_row(
                ...
                IncidentActionItem,
                pk_field="id",
                pk_value=seed_uuid("incident-action-item", key, str(idx)),
                incident_id=incident.id,
                title=str(item["title"]),
                owner_user_id=users[str(item["owner_key"])].id,
                due_at=item.get("due_at") or BASE_TS + timedelta(days=idx + 1),
                status=str(item.get("status", "open")),
                notes_md=str(item.get("notes_md", "")),
                created_by=users[created_by].id,
                created_at=ts(days_ago=5, hours=idx),
                completed_at=ts(days_ago=1) if item.get("status") == "done" else None,
            )
            if item.get("status") != "done":
                upsert_row(
                    ...
                    IncidentActionReminder,
                    pk_field="id",
                    pk_value=seed_uuid("incident-action-reminder", key, str(idx)),
                    incident_id=incident.id,
                    action_item_id=action.id,
                    owner_user_id=users[str(item["owner_key"])].id,
                    reminder_key=f"reminder-{idx}",
                    channel="in_app",
                    due_at_snapshot=item.get("due_at")
                    or BASE_TS + timedelta(days=idx + 1),
                    created_at=ts(days_ago=1, hours=idx),
                )
        if related_doc is not None:
            upsert_row(
                ...
                IncidentLink,
                pk_field="id",
                pk_value=seed_uuid("incident-link", key, "doc"),
                incident_id=incident.id,
                target_type="doc",
                target_id=related_doc.id,
                label=related_doc.title,
                created_by=users[created_by].id,
        ...
        if related_sop is not None:
            upsert_row(
                ...
                IncidentLink,
                pk_field="id",
                pk_value=seed_uuid("incident-link", key, "sop"),
                incident_id=incident.id,
                target_type="sop",
                target_id=related_sop.id,
                label=related_sop.title,
                created_by=users[created_by].id,
                created_at=ts(days_ago=5),
            )
        upsert_translation_variants_for_fields(
            ...
            content_kind="incident",
            content_id=incident.id,
            fields={"title": incident.title, "summary_md": incident.summary_md},
            actor_user_id=users[on_call_key].id,
        )
        return incident
    ...
    space_specs = [
        {
            ...
            "region_code": "GLOBAL",
            "policy_synonyms": {"handoff": ["shift handoff", "leadership handoff"]},
        },
        {
            "key": "na-support",
            "slug": "north-america-support",
            "name": "North America Support Space",
            "region_code": "NA",
            "policy_synonyms": {"refund": ["reimbursement", "charge reversal"]},
        },
        {
            "key": "na-retail",
            "slug": "north-america-retail",
            "name": "North America Retail Operations",
            "region_code": "NA",
            "policy_synonyms": {"lane": ["register", "payment lane"]},
        },
        {
            "key": "eu-support",
            "slug": "europe-support",
            "name": "Europe Support Space",
            "region_code": "EU",
            "policy_synonyms": {"chargeback": ["dispute", "billing reversal"]},
        },
        {
            "key": "eu-retail",
            "slug": "europe-retail",
            "name": "Europe Retail Operations",
            "region_code": "EU",
            "policy_synonyms": {"reconciliation": ["closeout", "cash balancing"]},
        },
    ]
    for offset, spec in enumerate(space_specs, start=1):
        space = get_or_create_space(
            db,
            slug=spec["slug"],
            name=spec["name"],
            created_at=ts(days_ago=70 - offset),
            region_code=spec["region_code"],
            meta={
                "scope": "global" if spec["key"] == "company-hub" else "department",
                "seed_cluster": "test-company",
        ...
        upsert_row(
            ...
            synonyms_json=json.dumps(spec["policy_synonyms"], ensure_ascii=False),
            lexicon_json=json.dumps(
                sorted(spec["policy_synonyms"].keys()), ensure_ascii=False
            ),
    ...
    global_doc = create_doc(
        space=refs["spaces"]["company-hub"],
        key="company-hub:daily-ops-brief",
        slug="daily-ops-brief",
        title="Daily Operations Brief",
        folder_path="Leadership",
        created_by="executive_director",
        updated_by="admin",
        review_due_at=BASE_TS + timedelta(days=5),
        reviewer_key="executive_director",
        tags=["leadership", "briefing", "daily"],
        content_lines=[
            "# Daily Operations Brief",
            "",
            "This space stays intentionally small for presentation demos.",
            "",
            "## What Leadership Checks Every Morning",
            "- Open incidents with customer-facing impact",
            "- Tasks blocked on cross-department approvals",
            "- SOP runs that need a manager handoff",
            "",
            "## Escalation Rule",
            "If any department is blocked for more than 30 minutes, create or update an incident before shifting ownership.",
        ],
    )
    create_doc(
        space=refs["spaces"]["company-hub"],
        key="company-hub:executive-escalation-directory",
        slug="executive-escalation-directory",
        title="Executive Escalation Directory",
        folder_path="Shared Playbooks/Handoffs",
        created_by="executive_director",
        updated_by="admin",
        review_due_at=BASE_TS + timedelta(days=14),
        reviewer_key="executive_director",
        tags=["leadership", "contact-list", "handoff"],
        content_lines=[
            "# Executive Escalation Directory",
            "",
            "| Role | Primary | Backup |",
            "| --- | --- | --- |",
            "| Executive Director | Avery Stone | Liam Brooks |",
            "| North America Support | Nora Patel | Maya Bennett |",
            "| Europe Retail Operations | Max Weber | Clara Fischer |",
        ],
    )
    global_sop = create_sop(
        space=refs["spaces"]["company-hub"],
        key="company-hub:cross-functional-handoff",
        slug="cross-functional-handoff",
        title="Cross-Functional Handoff Procedure",
        folder_path="Shared Playbooks/Handoffs",
        owner_key="executive_director",
        reviewer_key="admin",
        cadence_days=1,
        next_due_at=BASE_TS + timedelta(hours=10),
        overview_lines=[
            "# Cross-Functional Handoff Procedure",
            "",
            "Use this run when ownership moves between departments during the working day.",
        ],
        steps=[
            {
                "step_order": 1,
                "title": "Capture current status",
                "body_md": "Summarize what is known, what is blocked, and what was already promised.",
            },
            {
                "step_order": 2,
                "title": "Confirm the next owner",
                "body_md": "State the receiving manager and verify they accepted the handoff.",
            },
            {
                "step_order": 3,
                "title": "Post the handoff note",
                "body_md": "Publish the final handoff note in the shared channel and attach any supporting evidence.",
            },
        ],
    )
    create_incident(
        space=refs["spaces"]["company-hub"],
        key="company-hub:sso-latency",
        folder_path="Leadership",
        title="SSO login latency affecting the executive dashboard",
        summary_lines=[
            "# Summary",
            "",
            "Leadership and department managers saw delayed login redirects during the morning review window.",
            "",
            "## Current State",
            "- Authentication succeeds",
            "- Login handoff is slower than expected",
            "- Department spaces remain reachable after login succeeds",
        ],
        status="resolved",
        severity=2,
        created_by="executive_director",
        on_call_key="admin",
        template_name="Leadership Platform Disruption",
        impacts=[
            {
                "service_name": "Executive dashboard access",
                "impact_level": "degraded",
                "blast_radius": "multi-service",
                "customer_facing": False,
                "notes_md": "Only internal leadership workflows were affected.",
            }
        ],
        status_updates=[
            {
                "stream_type": "private",
                "status": "identified",
                "message_md": "Login redirect latency is isolated to the SSO callback path.",
                "created_by": "admin",
                "created_at": ts(days_ago=5, hours=20),
            },
            {
                "stream_type": "public",
                "status": "resolved",
                "message_md": "Mitigation is live and leadership dashboards are responding normally again.",
                "created_by": "executive_director",
                "created_at": ts(days_ago=5, hours=6),
            },
        ],
        action_items=[
            {
                "title": "Add callback latency to the morning leadership checklist",
                "owner_key": "admin",
                "status": "done",
                "notes_md": "Added to the Company Operations Hub brief.",
                "due_at": BASE_TS + timedelta(days=2),
            }
        ],
        postmortem_lines=[
            "# Postmortem",
            "",
            "- Root cause: slow SSO callback cache warm-up after the nightly deploy.",
            "- Resolution: pre-warm callback cache before business hours.",
        ],
        related_doc=global_doc,
        related_sop=global_sop,
    )

    na_support_doc = create_doc(
        space=refs["spaces"]["na-support"],
        key="na-support:refund-eligibility-matrix",
        slug="refund-eligibility-matrix",
        title="Refund Eligibility Matrix",
        folder_path="Policies/Billing",
        created_by="na_support_manager",
        updated_by="member",
        review_due_at=BASE_TS - timedelta(days=2),
        reviewer_key="na_support_manager",
        ...
        content_lines=[
            ...
            "| Scenario | Window | Approval | Notes |",
            "| --- | --- | --- | --- |",
            "| Duplicate charge | 30 days | Tier-1 | Verify payment processor settlement IDs before approving. |",
            "| Damaged item | 14 days | Tier-1 | Photo required for shipped orders. |",
            "| Subscription renewal dispute | 7 days | Billing lead | Check cancellation timestamp before confirming. |",
            "| Fraud claim | N/A | Payments team | Escalate immediately and pause any manual refunds. |",
        ],
    )
    create_doc(
        space=refs["spaces"]["na-support"],
        key="na-support:vip-escalation-routing",
        slug="vip-escalation-routing",
        title="VIP Escalation Routing",
        folder_path="Escalations",
        created_by="na_support_manager",
        updated_by="na_support_specialist",
        review_due_at=BASE_TS + timedelta(days=9),
        reviewer_key="na_support_manager",
        tags=["vip", "escalation", "routing"],
        content_lines=[
            "# VIP Escalation Routing",
            "",
            "Escalate any subscription, refund, or outage issue tied to premium accounts within five minutes.",
            "",
            "## Required Context",
            "- Account ID",
            "- Promise already made to the customer",
            "- Next callback owner",
        ],
    )
    na_support_sop = create_sop(
        space=refs["spaces"]["na-support"],
        key="na-support:refund-delay-triage",
        slug="refund-delay-triage",
        title="Refund Delay Triage",
        folder_path="Escalations",
        owner_key="na_support_manager",
        reviewer_key="member",
        cadence_days=7,
        next_due_at=BASE_TS + timedelta(days=2),
        overview_lines=[
            "# Refund Delay Triage",
            "",
            "Use this SOP when the refund queue is delayed and customers are already waiting for confirmation emails.",
        ],
        steps=[
            {
                "step_order": 1,
                "title": "Confirm queue impact",
                "body_md": "Validate processor timeouts, queue age, and the affected brands or storefronts.",
            },
            {
                "step_order": 2,
                "title": "Publish the support macro",
                "body_md": "Use the approved delay macro and set callback expectations for affected customers.",
            },
            {
                "step_order": 3,
                "title": "Escalate if SLA is at risk",
                "body_md": "Page billing leadership and attach queue screenshots if the SLA breach is unavoidable.",
            },
        ],
    )
    create_incident(
        space=refs["spaces"]["na-support"],
        key="na-support:refund-queue-delay",
        folder_path="Escalations",
        title="Refund confirmations delayed for North America orders",
        summary_lines=[
            "# Summary",
            "",
            "Confirmation emails were delayed after payment gateway retries accumulated overnight.",
            "",
            "## Customer Impact",
            "- Customers can still request refunds",
            "- Confirmation emails arrive later than normal",
            "- Agents need the delay macro until queue age returns to normal",
        ],
        status="monitoring",
        severity=2,
        created_by="na_support_manager",
        on_call_key="member",
        template_name="North America Billing Delay",
        impacts=[
            {
                "service_name": "Refund confirmation pipeline",
                "impact_level": "degraded",
                "blast_radius": "department",
                "customer_facing": True,
                "notes_md": "Only North America storefront emails are delayed.",
            }
        ],
        status_updates=[
            {
                "stream_type": "private",
                "status": "identified",
                "message_md": "Gateway retries climbed sharply after 02:00 UTC and slowed the confirmation workers.",
                "created_by": "member",
                "created_at": ts(days_ago=1, hours=18),
            },
            {
                "stream_type": "public",
                "status": "monitoring",
                "message_md": "Retry throughput is healthy again and the queue is draining. Agents should keep using the approved delay macro until backlog clears.",
                "created_by": "na_support_manager",
                "created_at": ts(days_ago=0, hours=10),
            },
        ],
        action_items=[
            {
                "title": "Refresh the refund delay macro",
                "owner_key": "member",
                "status": "in_progress",
                "notes_md": "Align macro wording with the current queue recovery estimate.",
                "due_at": BASE_TS + timedelta(days=1),
            },
            {
                "title": "Confirm callback ownership for premium accounts",
                "owner_key": "na_support_manager",
                "status": "open",
                "notes_md": "Escalated customers need named callback owners before end of day.",
                "due_at": BASE_TS + timedelta(days=2),
            },
        ],
        postmortem_lines=None,
        related_doc=na_support_doc,
        related_sop=na_support_sop,
    )

    na_retail_doc = create_doc(
        space=refs["spaces"]["na-retail"],
        key="na-retail:weekend-store-readiness-brief",
        slug="weekend-store-readiness-brief",
        title="Weekend Store Readiness Brief",
        folder_path="Opening",
        created_by="na_ops_manager",
        updated_by="admin",
        review_due_at=BASE_TS + timedelta(days=4),
        reviewer_key="na_ops_manager",
        tags=["opening", "weekend", "briefing"],
        content_lines=[
            "# Weekend Store Readiness Brief",
            "",
            "- Confirm opening manager coverage by 08:00 local time.",
            "- Validate printer supplies and backup payment terminals.",
            "- Review any active incidents before customer doors open.",
        ],
    )
    create_doc(
        space=refs["spaces"]["na-retail"],
        key="na-retail:receipt-printer-swap-notes",
        slug="receipt-printer-swap-notes",
        title="Receipt Printer Swap Notes",
        folder_path="Hardware/Printers",
        created_by="na_ops_manager",
        updated_by="na_ops_coordinator",
        review_due_at=BASE_TS + timedelta(days=12),
        reviewer_key="na_ops_manager",
        tags=["hardware", "printer", "lane"],
        content_lines=[
            "# Receipt Printer Swap Notes",
            "",
            "Keep spare label stock, USB cables, and the latest firmware image with each replacement unit.",
            "",
            "## After a Swap",
            "- Print a test receipt",
            "- Confirm the lane number in the asset log",
            "- Close the task only after cashier signoff",
        ],
    )
    na_retail_sop = create_sop(
        space=refs["spaces"]["na-retail"],
        key="na-retail:replace-pos-receipt-printer",
        slug="replace-pos-receipt-printer",
        title="Replace POS Receipt Printer",
        folder_path="Hardware/Printers",
        owner_key="na_ops_manager",
        reviewer_key="admin",
        cadence_days=14,
        next_due_at=BASE_TS + timedelta(days=1),
        overview_lines=[
            "# Replace POS Receipt Printer",
            "",
            "Use this SOP whenever a lane printer fails validation or repeatedly jams during trading hours.",
        ],
        steps=[
            {
                "step_order": 1,
                "title": "Pause the affected lane",
                "body_md": "Notify the cashier, pause the lane, and redirect customers if needed.",
            },
            {
                "step_order": 2,
                "title": "Install the replacement unit",
                "body_md": "Swap the printer, label it, and reconnect the approved USB cable.",
            },
            {
                "step_order": 3,
                "title": "Validate and reopen",
                "body_md": "Run a test receipt, confirm the lane log, and reopen only after cashier confirmation.",
            },
        ],
    )
    create_incident(
        space=refs["spaces"]["na-retail"],
        key="na-retail:chicago-payment-lane",
        folder_path="Hardware",
        title="Chicago flagship payment lane degraded during afternoon peak",
        summary_lines=[
            "# Summary",
            "",
            "Lane 4 degraded after repeated printer validation failures and intermittent payment terminal reconnects.",
            "",
            "## Operational Impact",
            "- One primary lane unavailable",
            "- Queue times rose above the store threshold",
            "- Replacement hardware is already on site",
        ],
        status="open",
        severity=3,
        created_by="na_ops_manager",
        on_call_key="admin",
        template_name="North America Lane Failure",
        impacts=[
            {
                "service_name": "Chicago flagship checkout",
                "impact_level": "degraded",
                "blast_radius": "single-service",
                "customer_facing": True,
                "notes_md": "Only one lane is affected and staff rerouted customers manually.",
            }
        ],
        status_updates=[
            {
                "stream_type": "private",
                "status": "identified",
                "message_md": "Replacement hardware is staged and waiting for the lane to clear.",
                "created_by": "admin",
                "created_at": ts(days_ago=0, hours=9),
            }
        ],
        action_items=[
            {
                "title": "Confirm Chicago spare inventory",
                "owner_key": "admin",
                "status": "open",
                "notes_md": "Verify two additional spare printers remain on site after the swap.",
                "due_at": BASE_TS + timedelta(days=1),
            }
        ],
        postmortem_lines=None,
        related_doc=na_retail_doc,
        related_sop=na_retail_sop,
    )

    eu_support_doc = create_doc(
        space=refs["spaces"]["eu-support"],
        key="eu-support:subscription-renewal-dispute-guide",
        slug="subscription-renewal-dispute-guide",
        title="Subscription Renewal Dispute Guide",
        folder_path="Billing",
        created_by="eu_support_manager",
        updated_by="viewer",
        review_due_at=BASE_TS + timedelta(days=8),
        reviewer_key="eu_support_manager",
        tags=["billing", "subscription", "dispute"],
        content_lines=[
            "# Subscription Renewal Dispute Guide",
            "",
            "Use this guide for customers who dispute a recurring renewal after a failed cancellation attempt.",
            "",
            "## Required Checks",
            "- Cancellation timestamp",
            "- Renewal invoice ID",
            "- Any prior concession granted in the last 90 days",
        ],
    )
    create_doc(
        space=refs["spaces"]["eu-support"],
        key="eu-support:escalation-qa-review-notes",
        slug="escalation-qa-review-notes",
        title="Escalation QA Review Notes",
        folder_path="Quality Reviews",
        created_by="eu_support_manager",
        updated_by="eu_support_specialist",
        review_due_at=BASE_TS + timedelta(days=16),
        reviewer_key="eu_support_manager",
        tags=["qa", "coaching", "escalation"],
        content_lines=[
            "# Escalation QA Review Notes",
            "",
            "- Confirm that severity matches customer impact.",
            "- Capture the next callback owner before closing the note.",
            "- Avoid publishing internal queue estimates in public replies.",
        ],
    )
    eu_support_sop = create_sop(
        space=refs["spaces"]["eu-support"],
        key="eu-support:chargeback-documentation-review",
        slug="chargeback-documentation-review",
        title="Chargeback Documentation Review",
        folder_path="Quality Reviews",
        owner_key="eu_support_manager",
        reviewer_key="viewer",
        cadence_days=14,
        next_due_at=BASE_TS + timedelta(days=3),
        overview_lines=[
            "# Chargeback Documentation Review",
            "",
            "Run this SOP before handing a disputed renewal or fraud case to the billing partner.",
        ],
        steps=[
            {
                "step_order": 1,
                "title": "Confirm the dispute type",
                "body_md": "Match the dispute reason to the correct billing evidence checklist.",
            },
            {
                "step_order": 2,
                "title": "Assemble required proof",
                "body_md": "Attach the invoice, timeline, and any customer acknowledgement already sent.",
            },
            {
                "step_order": 3,
                "title": "Hand off to billing",
                "body_md": "Record the owner, due date, and the expected next update for support.",
            },
        ],
    )
    create_incident(
        space=refs["spaces"]["eu-support"],
        key="eu-support:german-inbox-backlog",
        folder_path="Billing",
        title="German support inbox backlog after billing retry storm",
        summary_lines=[
            "# Summary",
            "",
            "German-language billing queues backed up after a provider retry storm created duplicate customer follow-ups.",
            "",
            "## Team Guidance",
            "- Prioritize premium customers first",
            "- Use the approved renewal dispute guide",
            "- Track callback ownership in the incident action list",
        ],
        status="monitoring",
        severity=2,
        created_by="eu_support_manager",
        on_call_key="viewer",
        template_name="Europe Billing Backlog",
        impacts=[
            {
                "service_name": "German billing support queue",
                "impact_level": "degraded",
                "blast_radius": "department",
                "customer_facing": True,
                "notes_md": "Queue response times are elevated but service remains available.",
            }
        ],
        status_updates=[
            {
                "stream_type": "private",
                "status": "identified",
                "message_md": "Duplicate retries caused several conversation reopenings in the German queue.",
                "created_by": "viewer",
                "created_at": ts(days_ago=0, hours=12),
            },
            {
                "stream_type": "public",
                "status": "monitoring",
                "message_md": "Backlog is improving. Premium callbacks remain prioritized until normal queue depth returns.",
                "created_by": "eu_support_manager",
                "created_at": ts(days_ago=0, hours=4),
            },
        ],
        action_items=[
            {
                "title": "Sample reopened cases for QA review",
                "owner_key": "viewer",
                "status": "open",
                "notes_md": "Focus on chargeback and renewal-dispute conversations.",
                "due_at": BASE_TS + timedelta(days=2),
            }
        ],
        postmortem_lines=None,
        related_doc=eu_support_doc,
        related_sop=eu_support_sop,
    )

    eu_retail_doc = create_doc(
        space=refs["spaces"]["eu-retail"],
        key="eu-retail:weekend-display-reset-plan",
        slug="weekend-display-reset-plan",
        title="Weekend Display Reset Plan",
        folder_path="Merchandising",
        created_by="eu_ops_manager",
        updated_by="moderator",
        review_due_at=BASE_TS + timedelta(days=6),
        reviewer_key="eu_ops_manager",
        tags=["merchandising", "weekend", "display"],
        content_lines=[
            "# Weekend Display Reset Plan",
            "",
            "Use this plan for Friday evening store resets before the weekend campaign lands.",
            "",
            "## Minimum Readiness",
            "- Confirm printed signage",
            "- Confirm replenishment stock",
            "- Confirm closeout owner for the final walkthrough",
        ],
    )
    create_doc(
        space=refs["spaces"]["eu-retail"],
        key="eu-retail:closing-reconciliation-checklist",
        slug="closing-reconciliation-checklist",
        title="Closing Reconciliation Checklist",
        folder_path="Cash Handling",
        created_by="eu_ops_manager",
        updated_by="eu_ops_coordinator",
        review_due_at=BASE_TS + timedelta(days=15),
        reviewer_key="eu_ops_manager",
        tags=["cash", "closeout", "checklist"],
        content_lines=[
            "# Closing Reconciliation Checklist",
            "",
            "- Match till totals before final export.",
            "- Record any manual adjustments before store close.",
            "- Escalate if unresolved variance remains above threshold.",
        ],
    )
    eu_retail_sop = create_sop(
        space=refs["spaces"]["eu-retail"],
        key="eu-retail:pos-reconciliation-escalation",
        slug="pos-reconciliation-escalation",
        title="POS Reconciliation Escalation",
        folder_path="Cash Handling",
        owner_key="eu_ops_manager",
        reviewer_key="moderator",
        cadence_days=7,
        next_due_at=BASE_TS + timedelta(days=1),
        overview_lines=[
            "# POS Reconciliation Escalation",
            "",
            "Run this SOP when store closeout does not reconcile and the variance crosses the defined threshold.",
        ],
        steps=[
            {
                "step_order": 1,
                "title": "Validate the variance",
                "body_md": "Double-check till exports and confirm the variance amount.",
            },
            {
                "step_order": 2,
                "title": "Collect evidence",
                "body_md": "Capture closeout totals, adjustments, and store owner notes.",
            },
            {
                "step_order": 3,
                "title": "Escalate to regional operations",
                "body_md": "Send the completed variance packet to the regional manager and finance owner.",
            },
        ],
    )
    create_incident(
        space=refs["spaces"]["eu-retail"],
        key="eu-retail:paris-stock-sync-lag",
        folder_path="Merchandising",
        title="Paris stock sync lag after overnight import",
        summary_lines=[
            "# Summary",
            "",
            "The Paris store opened with stale stock counts after the overnight import finished late.",
            "",
            "## Current State",
            "- Store is operating with manual stock confirmation for priority SKUs",
            "- Merchandising updates are paused until counts normalize",
        ],
        status="resolved",
        severity=3,
        created_by="eu_ops_manager",
        on_call_key="moderator",
        template_name="Europe Stock Sync Lag",
        impacts=[
            {
                "service_name": "Paris stock visibility",
                "impact_level": "degraded",
                "blast_radius": "single-service",
                "customer_facing": True,
                "notes_md": "Store operations resumed normally after counts caught up.",
            }
        ],
        status_updates=[
            {
                "stream_type": "private",
                "status": "identified",
                "message_md": "Overnight import finished after the merchandising reset window closed.",
                "created_by": "moderator",
                "created_at": ts(days_ago=2, hours=8),
            },
            {
                "stream_type": "public",
                "status": "resolved",
                "message_md": "Counts are current again and the Paris store returned to standard closeout flow.",
                "created_by": "eu_ops_manager",
                "created_at": ts(days_ago=1, hours=20),
            },
        ],
        action_items=[
            {
                "title": "Confirm overnight import guardrail before next weekend reset",
                "owner_key": "moderator",
                "status": "done",
                "notes_md": "Guardrail updated in the closeout checklist.",
                "due_at": BASE_TS + timedelta(days=4),
            }
        ],
        postmortem_lines=[
            "# Postmortem",
            "",
            "- Root cause: overnight import batch missed its expected finish window.",
            "- Resolution: pause display reset when sync backlog exceeds threshold.",
        ],
        related_doc=eu_retail_doc,
        related_sop=eu_retail_sop,
    )


def seed_presentation_tasks_runtime_and_branding(
    db: Session,
    users: dict[str, User],
    refs: dict[str, dict[str, Any]],
) -> None:
    ...
    def create_run(
        *,
        ...
        run = upsert_row(
            ...
            SopRun,
            pk_field="id",
            pk_value=seed_uuid("sop-run", key),
            sop_id=sop.id,
            status=status,
            started_by=users[started_by_key].id,
            started_at=ts(days_ago=0, hours=8),
            completed_at=ts(days_ago=0, hours=2) if status == "completed" else None,
        )
        for order, step in sop_steps_by_order(db, sop).items():
            upsert_row(
                db,
                SopRunStep,
                pk_field="id",
                pk_value=seed_uuid("sop-run-step", key, str(order)),
                run_id=run.id,
                step_id=step.id,
                step_order=order,
                title=step.title,
                evidence_required=order == 3,
                completed=order in completed_orders,
                completed_at=ts(days_ago=0, hours=6 - order)
                if order in completed_orders
                else None,
                completed_by=users[started_by_key].id
                if order in completed_orders
                else None,
                evidence_note="Photo attached to lane log."
                if order == 3 and order in completed_orders
                else "",
                evidence_min_files=1 if order == 3 else 0,
                evidence_allowed_extensions_csv="jpg,png,pdf" if order == 3 else "",
            )
        refs["sop_runs"][key] = run
        return run

    company_run = create_run(
        key="company-hub:cross-functional-handoff:morning",
        sop_key="company-hub:cross-functional-handoff",
        started_by_key="admin",
        status="in_progress",
        completed_orders={1, 2},
    )
    na_support_run = create_run(
        key="na-support:refund-delay-triage:queue-watch",
        sop_key="na-support:refund-delay-triage",
        started_by_key="member",
        status="in_progress",
        completed_orders={1},
    )
    eu_retail_run = create_run(
        key="eu-retail:pos-reconciliation-escalation:paris-closeout",
        sop_key="eu-retail:pos-reconciliation-escalation",
        started_by_key="moderator",
        status="completed",
    ...
    task_specs = [
        {
            "key": "company-hub:tomorrows-ops-review",
            "space_key": "company-hub",
            "title": "Finalize tomorrow's operations review deck",
            "description": "Confirm open incidents, blocked work, and active SOP runs before the presentation walkthrough.",
            "status": "in_progress",
            "priority": "high",
            "assignee_key": "admin",
            "created_by_key": "executive_director",
            "source_kind": None,
            "source_id": None,
            "due_at": BASE_TS + timedelta(hours=12),
        },
        {
            "key": "company-hub:cross-functional-handoff-followup",
            "space_key": "company-hub",
            "title": "Continue the cross-functional handoff run",
            "description": "Complete the final posted handoff note and keep leadership visibility current.",
            "status": "todo",
            "priority": "medium",
            "assignee_key": "admin",
            "created_by_key": "executive_director",
            "source_kind": "sop_run",
            "source_id": company_run.id,
            "due_at": BASE_TS + timedelta(hours=8),
        },
        {
            "key": "na-support:refresh-refund-delay-macro",
            "space_key": "na-support",
            "title": "Refresh the North America refund delay macro",
            "description": "Update the wording to match the current recovery window and callback promise.",
            "status": "in_progress",
            "priority": "high",
            "assignee_key": "member",
            "created_by_key": "na_support_manager",
            "source_kind": "incident",
            "source_id": refs["incidents"]["na-support:refund-queue-delay"].id,
            "due_at": BASE_TS + timedelta(days=1),
        },
        {
            "key": "na-retail:confirm-chicago-spares",
            "space_key": "na-retail",
            "title": "Confirm spare printer stock for Chicago flagship",
            "description": "Verify the replacement inventory after today's lane degradation incident.",
            "status": "todo",
            "priority": "medium",
            "assignee_key": "na_ops_manager",
            "created_by_key": "admin",
            "source_kind": "incident",
            "source_id": refs["incidents"]["na-retail:chicago-payment-lane"].id,
            "due_at": BASE_TS + timedelta(days=1),
        },
        {
            "key": "eu-support:week-26-qa-sample",
            "space_key": "eu-support",
            "title": "Sample week 26 escalation cases for QA review",
            "description": "Collect reopened German billing cases and score them against the review notes.",
            "status": "todo",
            "priority": "medium",
            "assignee_key": "eu_support_manager",
            "created_by_key": "viewer",
            "source_kind": "sop_run",
            "source_id": na_support_run.id,
            "due_at": BASE_TS + timedelta(days=2),
        },
        {
            "key": "eu-retail:publish-paris-recovery-note",
            "space_key": "eu-retail",
            "title": "Publish the Paris stock-sync recovery note",
            "description": "Close the incident communication loop and attach the reconciled closeout evidence.",
            "status": "done",
            "priority": "low",
            "assignee_key": "moderator",
            "created_by_key": "eu_ops_manager",
            "source_kind": "sop_run",
            "source_id": eu_retail_run.id,
            "due_at": ts(days_ago=1),
        },
    ]
    for offset, spec in enumerate(task_specs, start=1):
        task = upsert_row(
            db,
            Task,
            pk_field="id",
            pk_value=seed_uuid("task", spec["key"]),
            space_id=refs["spaces"][spec["space_key"]].id,
            title=spec["title"],
            description=spec["description"],
            status=spec["status"],
            priority=spec["priority"],
            assignee_user_id=users[spec["assignee_key"]].id,
            created_by=users[spec["created_by_key"]].id,
            source_kind=spec["source_kind"],
            source_id=spec["source_id"],
            source_step_id=None,
            due_at=spec["due_at"],
            created_at=ts(days_ago=4 - min(offset, 3)),
            updated_at=ts(days_ago=0, hours=offset),
        )
        refs["tasks"][spec["key"]] = task

    comment_specs = [
        (
            "company-hub:tomorrows-ops-review",
            "executive-note",
            "executive_director",
            "Keep the review simple: one slide for incidents, one for task risk, one for active handoffs.",
        ),
        (
            "na-support:refresh-refund-delay-macro",
            "macro-note",
            "member",
            "Draft is ready. I only need Nora's final signoff on the callback promise wording.",
        ),
        (
            "na-retail:confirm-chicago-spares",
            "spare-note",
            "na_ops_manager",
            "Chicago still has two spare printers after today's swap. Asset log updated.",
        ),
    ]
    for task_key, comment_key, author_key, body in comment_specs:
        task = refs["tasks"][task_key]
        comment = upsert_row(
            db,
            TaskComment,
            pk_field="id",
            pk_value=seed_uuid("task-comment", task_key, comment_key),
            task_id=task.id,
            space_id=task.space_id,
            author_user_id=users[author_key].id,
            body=body,
            created_at=ts(days_ago=0, hours=7),
            updated_at=ts(days_ago=0, hours=6),
        )
        refs["task_comments"][f"{task_key}:{comment_key}"] = comment
    ...
    upsert_row(
        ...
        application_title="Test Companie's Opsatlas Client",
        application_short_name="OpsAtlas",
        web_description="Presentation workspace for Test Company incidents, SOPs, knowledge, and assigned tasks.",
        apple_web_app_title="OpsAtlas",
        logo_url=None,
        light_logo_url=None,
        dark_logo_url=None,
    ...
    upsert_row(
        ...
        BrandingRevision,
        pk_field="id",
        pk_value=seed_uuid("branding-revision", "presentation-1"),
        revision_number=1,
        source_kind="seed",
        source_revision_id=None,
        summary="Seeded presentation branding for Test Company",
        snapshot_json=json.dumps(
            draft_snapshot, ensure_ascii=False, separators=(",", ":")
        ),
        published_by_user_id=users["admin"].id,
        published_at=ts(days_ago=4),
        created_at=ts(days_ago=4),
    )
    ...
    for user_key, space_key in dashboard_defaults:
        upsert_row(
            db,
            UserDashboardPreference,
            pk_field="user_id",
            ...
            hidden_widgets_json=json.dumps([], separators=(",", ":")),
            feed_seen_at=ts(days_ago=0, hours=1),
            updated_at=ts(days_ago=0, hours=1),
        )
    ...
    for user_key, language_code in localization_preferences.items():
        upsert_row(
            db,
            UserLocalizationPreference,
            pk_field="user_id",
...
def seed_presentation_space_links_and_events(
    db: Session,
    users: dict[str, User],
    refs: dict[str, dict[str, Any]],
) -> None:
    space_links = [
        ("north-america-region", "company-hub", "viewer", True),
        ("europe-region", "company-hub", "viewer", True),
        ("north-america-customer-support", "na-support", "member", True),
        ("north-america-retail-operations", "na-retail", "member", True),
        ("europe-customer-support", "eu-support", "member", True),
        ("europe-retail-operations", "eu-retail", "member", True),
    ]
    for department_key, space_key, grant_role, inherit in space_links:
        upsert_org_item_link(
            db,
            parent_kind="department",
            parent_id=refs["departments"][department_key].id,
            child_kind="space",
            child_id=refs["spaces"][space_key].id,
            grant_role=grant_role,
            inherit_to_descendants=inherit,
    ...
    event_specs = [
        (
            "event-company-brief-open",
            ts(days_ago=0, hours=5),
            "open",
            "admin",
            "company-hub",
            "doc",
            refs["docs"]["company-hub:daily-ops-brief"].id,
            "/spaces/%s?docSlug=daily-ops-brief" % refs["spaces"]["company-hub"].id,
            {
                "surface": "space_workspace",
                "entity_title": "Daily Operations Brief",
                "detail_text": "Leadership checked the morning operations brief before the review.",
            },
        ),
        (
            "event-na-incident-update",
            ts(days_ago=0, hours=4),
            "incident_status_update",
            "member",
            "na-support",
            "incident",
            refs["incidents"]["na-support:refund-queue-delay"].id,
            "/spaces/%s?incidentId=%s"
            % (
                refs["spaces"]["na-support"].id,
                refs["incidents"]["na-support:refund-queue-delay"].id,
            ),
            {
                "surface": "space_workspace",
                "incident_title": "Refund confirmations delayed for North America orders",
                "detail_text": "Queue throughput is healthy again and the backlog is shrinking.",
            },
        ),
        (
            "event-na-task-comment",
            ts(days_ago=0, hours=3),
            "task_updated",
            "na_ops_manager",
            "na-retail",
            "task",
            refs["tasks"]["na-retail:confirm-chicago-spares"].id,
            "/tasks?spaceId=%s" % refs["spaces"]["na-retail"].id,
            {
                "surface": "tasks",
                "task_title": "Confirm spare printer stock for Chicago flagship",
                "detail_text": "Chicago still has two spare printers after today's swap.",
            },
        ),
        (
            "event-eu-sop-open",
            ...
            "eu-retail",
            "sop",
            refs["sops"]["eu-retail:pos-reconciliation-escalation"].id,
            "/spaces/%s?sopSlug=pos-reconciliation-escalation"
            % refs["spaces"]["eu-retail"].id,
            {
                "surface": "space_workspace",
                "sop_title": "POS Reconciliation Escalation",
                "detail_text": "Europe retail reopened the reconciliation SOP during closeout follow-up.",
            },
        ),
        (
            "event-eu-doc-open",
            ...
            "eu-support",
            "doc",
            refs["docs"]["eu-support:subscription-renewal-dispute-guide"].id,
            "/spaces/%s?docSlug=subscription-renewal-dispute-guide"
            % refs["spaces"]["eu-support"].id,
            {
                "surface": "space_workspace",
                "doc_title": "Subscription Renewal Dispute Guide",
                "detail_text": "The Europe support team reopened the renewal dispute guide during callback prep.",
            },
        ),
    ]
    for (
...
def seed_all(db: Session) -> None:
    ...
    users = seed_presentation_users(db)
    refs["users"] = users  # convenience for debugging

    seed_presentation_organization(db, users, refs)
    seed_presentation_spaces(db, users, refs)
    seed_presentation_tasks_runtime_and_branding(db, users, refs)
    seed_presentation_space_links_and_events(db, users, refs)
